...
public class UserController {
    ...
    public ResponseEntity<String> updateemail(@RequestParam("userid")String userid, @RequestParam("email") String email){
        ms.updateemail(userid, email);
        return ResponseEntity.ok(userid+" : " + email);
    }
    @GetMapping("/getCrseq")
